...
/**
 * Retrieves the details of the about section from the server and invokes the provided callback function.
 *
 ...
 */
const aboutDetail = (callback) => {
    axios.get(`${host}/about`, { headers })
    .then((res) => {
